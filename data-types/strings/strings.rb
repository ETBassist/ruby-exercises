...
class StringTest < Minitest::Test
  ...
  def test_5
    ...
    word = "ticking" # Could require word#sub instead of word#gsub by using tight => fight instead
    # In place of the line below, call a method to achieve the expected output.
    actual = word.sub('t', 'k') # ______
    expected = "kicking"
  ...
  def test_8
    ...
    greeting = "Hello!!"
    # In place of the line below, call a method to achieve the expected output.
    actual = greeting.chop # delete_suffix('!') # _____
    expected = "Hello!"
  ...
  def test_17
    ...
    actual = greeting.count('eo') # _____
    expected = 3
  ...
  def test_18
    ...
    actual = greeting.include? 'llo' # _____
    expected = true
  ...
  def test_19
    ...
    actual = greeting.include? 'lol' # _____
    expected = false
  ...
  def test_20
    ...
    actual = greeting + " " + name # _________
  ...
  def test_24
    ...
    actual = phrase.strip.chomp # ________
