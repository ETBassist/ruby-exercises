...
class WerewolfTest < Minitest::Test
  ...
  def test_consumes_a_victim
    werewolf = Werewolf.new("Jorge")
    werewolf.change!
    george = Victim.new("George")
    werewolf.consume(george)
    assert_equal werewolf.stomach.length, 1
    # your code here
  end
  ...
  def test_cannot_consume_victim_if_in_human_form
    ...
    george = Victim.new("George")
    werewolf.consume(george)
    assert_equal george.status, :alive
    # your code here
  end
  ...
  def test_a_werewolf_who_has_consumed_a_victim_makes_the_victim_dead
    ...
    george = Victim.new("George")
    werewolf.consume(george)
    assert_equal george.status, :dead
    # your code here
  end
