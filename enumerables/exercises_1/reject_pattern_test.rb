...
class RejectPatternTest < Minitest::Test
  ...
  def test_remove_vowels
    ...
    letters.each do |letter|
      if letter.end_with?("a", "e", "i", "o", "u", "y") != true
        remaining << letter
      end
    end
  ...
  def test_remove_dinosaurs
    ...
    animals.each do |animal|
      if animal.include?("saurus") == false
        notasaurus << animal
      end
    end# Your code goes here
  ...
  def test_remove_numbers
    ...
    elements.each do |element|
      if element.kind_of?(Numeric) == false
        not_numbers << element
      end
    end# Your code goes here
  ...
  def test_remove_floats
    ...
    not_numbers = []
    elements.each do |element|
      if element.kind_of?(Float) == false
        not_numbers << element
      end
    end# Your code goes here
  ...
  def test_remove_animals_starting_with_vowels
    ...
    remaining = []
    animals.each do |animal|
      if animal.start_with?("a", "e", "i", "o", "u") == false
        remaining << animal
      end
    end# Your code goes here
