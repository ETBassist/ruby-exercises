...
class ZipTest < Minitest::Test
  ...
  def test_menu
    ...
    list2 = [29, 23, 26]
    prices = list1.zip(list2)# Your code goes here
  ...
  def test_lottery_tickets
    list1 = ["Alice", "Bob", "Charlie"]
    list2 = [298, 166, 237]
    tickets = list1.zip(list2)# Your code goes here
  ...
  def test_equivalent_dna_sequences
    ...
    pairs = strand1.zip(strand2)# Your code goes here
  ...
  def test_solitaire
    ...
    cards = list1.zip(list2)# Your code goes here
  ...
  def test_colors
    ...
    fashion = list1.zip(list2)# Your code goes here
